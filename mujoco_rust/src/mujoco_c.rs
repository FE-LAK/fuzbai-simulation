...
impl Default for std_iterator_traits {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl<_T1, _T2> Default for std_pair<_T1, _T2> {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl<_Iter> Default for std_reverse_iterator<_Iter> {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl<_Iter> Default for std___wrap_iter<_Iter> {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub type std___optional_sfinae_ctor_base_t = u8;
pub type std___optional_sfinae_assign_base_t = u8;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
impl Default for std___shared_count {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
unsafe extern "C" {
    #[link_name = "\u{1}_ZNSt3__114__shared_countD1Ev"]
...
unsafe extern "C" {
    #[link_name = "\u{1}_ZNSt3__119__shared_weak_countD1Ev"]
    pub fn std___shared_weak_count___shared_weak_count_destructor(
        this: *mut std___shared_weak_count,
    );
}
unsafe extern "C" {
    #[link_name = "\u{1}_ZNKSt3__119__shared_weak_count13__get_deleterERKSt9type_info"]
...
pub type std_shared_ptr_weak_type<_Tp> = std_weak_ptr<_Tp>;
pub type std_shared_ptr_element_type<_Tp> = std_remove_extent_t<_Tp>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct std_shared_ptr___shared_ptr_default_delete {
    pub _address: u8,
}
impl Default for std_shared_ptr___shared_ptr_default_delete {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl<_Tp> Default for std_shared_ptr<_Tp> {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub type std_weak_ptr_element_type<_Tp> = std_remove_extent_t<_Tp>;
impl<_Tp> Default for std_weak_ptr<_Tp> {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for std_basic_string___long {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl<_CharT> Default for std_basic_string___short<_CharT> {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl<_CharT> Default for std_basic_string___ulx<_CharT> {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for std_basic_string___raw {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl<_CharT> Default for std_basic_string___rep__bindgen_ty_1<_CharT> {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl<_CharT> Default for std_basic_string___rep<_CharT> {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for std_basic_string {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
unsafe extern "C" {
    #[link_name = "\u{1}_ZNSt3__15mutex4lockEv"]
    pub fn std_mutex_lock(this: *mut std_mutex);
}
unsafe extern "C" {
    #[link_name = "\u{1}_ZNSt3__15mutex8try_lockEv"]
    pub fn std_mutex_try_lock(this: *mut std_mutex) -> bool;
}
unsafe extern "C" {
    #[link_name = "\u{1}_ZNSt3__15mutex6unlockEv"]
...
unsafe extern "C" {
    #[link_name = "\u{1}_ZNSt3__118condition_variable10notify_oneEv"]
    pub fn std_condition_variable_notify_one(this: *mut std_condition_variable);
}
unsafe extern "C" {
    #[link_name = "\u{1}_ZNSt3__118condition_variable10notify_allEv"]
    pub fn std_condition_variable_notify_all(this: *mut std_condition_variable);
}
unsafe extern "C" {
    #[link_name = "\u{1}_ZNSt3__118condition_variable4waitERNS_11unique_lockINS_5mutexEEE"]
...
unsafe extern "C" {
    #[link_name = "\u{1}_ZNSt3__118condition_variableD1Ev"]
...
impl Default for std_vector___destroy_vector {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for std_vector__ConstructTransaction {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub struct std_condition_variable_any {
    ...
    pub __mut_: std_shared_ptr<std_mutex>,
}
impl Default for std_condition_variable_any {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for std_type_info {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub type mjStringVec = std_vector;
pub type mjIntVec = std_vector;
pub type mjIntVecVec = std_vector;
pub type mjFloatVec = std_vector;
pub type mjFloatVecVec = std_vector;
pub type mjDoubleVec = std_vector;
pub type mjByteVec = std_vector;
...
pub struct mujoco_GlfwAdapter {
    ...
    pub window_pos_: std_pair<::std::os::raw::c_int, ::std::os::raw::c_int>,
    pub window_size_: std_pair<::std::os::raw::c_int, ::std::os::raw::c_int>,
}
unsafe extern "C" {
    #[link_name = "\u{1}_ZNK6mujoco11GlfwAdapter17GetCursorPositionEv"]
    pub fn mujoco_GlfwAdapter_GetCursorPosition(
...
impl Default for mujoco_GlfwAdapter {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl mujoco_GlfwAdapter {
    #[inline]
    pub unsafe fn GetCursorPosition(&self) -> std_pair<f64, f64> {
    ...
    #[inline]
    pub unsafe fn GetFramebufferSize(
        &self,
    ) -> std_pair<::std::os::raw::c_int, ::std::os::raw::c_int> {
        mujoco_GlfwAdapter_GetFramebufferSize(self)
    }
    #[inline]
    pub unsafe fn GetWindowSize(&self) -> std_pair<::std::os::raw::c_int, ::std::os::raw::c_int> {
...
impl Default for mujoco_SimulateMutex {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub type mujoco_MutexLock = std_unique_lock<std_recursive_mutex>;
#[repr(C)]
pub struct mujoco_Simulate {
    ...
    pub body_parentid_: std_vector,
    pub jnt_type_: std_vector,
    pub jnt_group_: std_vector,
    pub jnt_qposadr_: std_vector,
    pub jnt_range_: std_vector,
    pub jnt_names_: std_vector,
    pub actuator_group_: std_vector,
    pub actuator_ctrlrange_: std_vector,
    pub actuator_names_: std_vector,
    pub history_: std_vector,
    pub qpos_: std_vector,
    pub qpos_prev_: std_vector,
    pub ctrl_: std_vector,
    pub ctrl_prev_: std_vector,
    ...
    pub last_fps_update_: std_chrono_time_point<std_chrono_duration<::std::os::raw::c_longlong>>,
    pub fps_: f64,
    ...
    pub user_figures_: std_vector,
    pub user_texts_: std_vector,
    pub user_images_: std_vector,
...
pub struct mujoco_Simulate__bindgen_ty_1 {
    pub save_xml: std_optional,
    pub save_mjb: std_optional,
    pub print_model: std_optional,
    pub print_data: std_optional,
    pub reset: bool,
    pub align: bool,
    pub copy_key: bool,
...
impl Default for mujoco_Simulate__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for mujoco_Simulate {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
